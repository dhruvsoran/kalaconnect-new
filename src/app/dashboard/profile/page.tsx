...
export default function ProfilePage() {
    ...
    if (authLoading || docLoading) {
        return <ProfileSkeleton isArtisan={true} />;
    }
    ...
    const handleSaveChanges = async (values: ProfileValues) => {
        ...
        setIsSaving(true);
        try {
            await setDoc(userDocRef, { ...profile, ...values }, { merge: true });
            toast({
                title: "Profile Saved!",
        ...
        <div className="grid gap-6 animate-fade-in-up">
            <div className="flex items-center">
                <h1 className="text-lg font-semibold md:text-2xl font-headline">
                    {isArtisan ? "Artisan Profile" : "My Profile"}
                </h1>
            </div>
             <Form {...form}>
                    ...
                    <Card className="shadow-lg border-none">
                        <CardHeader>
                            <CardTitle>Profile Picture</CardTitle>
                             <CardDescription>
                                Upload a photo that represents your craft.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
...
function ProfileSkeleton({ isArtisan }: { isArtisan: boolean }) {
    return (
        <div className="grid gap-6">
            <h1 className="text-2xl font-bold font-headline"><Skeleton className="h-8 w-48" /></h1>
